...
win32 {
  ...
  BOOST_INCLUDE_PATH=C:/devel/boost_1_58_0
  BOOST_LIB_PATH=C:/devel/boost_1_58_0/stage/lib
  BDB_INCLUDE_PATH=C:/devel/db-4.8.30/build_unix
  BDB_LIB_PATH=C:/devel/db-4.8.30/build_unix/
  OPENSSL_INCLUDE_PATH=C:/devel/openssl-1.0.1k/include
  OPENSSL_LIB_PATH=C:/devel/openssl-1.0.1k
...
isEmpty(BDB_LIB_PATH) {
    ...
    windows:BDB_LIB_PATH = C:\devel\db-4.8.30.NC\build_unix
}
...
isEmpty(BDB_INCLUDE_PATH) {
    ...
    windows:BDB_INCLUDE_PATH = C:\devel\db-4.8.30.NC\build_unix
}

isEmpty(OPENSSL_LIB_PATH) {
    macx:OPENSSL_LIB_PATH = /opt/local/lib
    windows:OPENSSL_LIB_PATH = C:\devel\openssl-1.0.1k
}

isEmpty(OPENSSL_INCLUDE_PATH) {
    macx:OPENSSL_INCLUDE_PATH = /opt/local/include/openssl
    windows:OPENSSL_INCLUDE_PATH = C:\devel\openssl-1.0.1k\include
}

isEmpty(BOOST_LIB_PATH) {
    macx:BOOST_LIB_PATH = /opt/local/lib
    windows:BOOST_LIB_PATH = C:\devel\boost_1_58_0\boost_1_58_0\stage\lib
}

isEmpty(BOOST_INCLUDE_PATH) {
    macx:BOOST_INCLUDE_PATH = /opt/local/include
    windows:BOOST_INCLUDE_PATH = C:\devel\boost_1_58_0\boost_1_58_0
}

isEmpty(MINIUPNPC_LIB_PATH) {
    macx:MINIUPNPC_LIB_PATH=/opt/local/lib
    windows:MINIUPNPC_LIB_PATH = C:\devel\miniupnpc
}

isEmpty(MINIUPNPC_INCLUDE_PATH) {
    macx:MINIUPNPC_INCLUDE_PATH=/opt/local/include/miniupnpc
    windows:MINIUPNPC_INCLUDE_PATH = C:\devel\miniupnpc
}
...
macx:ICON = src/qt/res/icons/GloveCoin.icns
macx:TARGET = "GloveCoin"
