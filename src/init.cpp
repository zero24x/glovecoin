...
void Shutdown()
{
    ...
    RenameThread("hotshotcoin-shutoff");
...
std::string HelpMessage()
{
    ...
    strUsage += "  -conf=<file>           " + _("Specify configuration file (default: hotshotcoin.conf)") + "\n";
    strUsage += "  -pid=<file>            " + _("Specify pid file (default: hotshotcoind.pid)") + "\n";
    ...
    strUsage += "  -port=<port>           " + _("Listen for connections on <port> (default: 22063 or testnet: 58200)") + "\n";
    ...
    strUsage += "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 22073 or testnet: 27058)") + "\n";
