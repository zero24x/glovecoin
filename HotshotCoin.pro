...
isEmpty(OPENSSL_LIB_PATH) {
    ...
    windows:OPENSSL_LIB_PATH = C:\devel\openssl-1.0.2o
}

isEmpty(OPENSSL_INCLUDE_PATH) {
    macx:OPENSSL_INCLUDE_PATH = /opt/local/include/openssl
    windows:OPENSSL_INCLUDE_PATH = C:\devel\openssl-1.0.2o\include
}

isEmpty(BOOST_LIB_PATH) {
    macx:BOOST_LIB_PATH = /opt/local/lib
    windows:BOOST_LIB_PATH = C:\devel\boost_1_55_0\boost_1_55_0\stage\lib
}

isEmpty(BOOST_INCLUDE_PATH) {
    macx:BOOST_INCLUDE_PATH = /opt/local/include
    windows:BOOST_INCLUDE_PATH = C:\devel\boost_1_55_0\boost_1_55_0
}
...
macx:ICON = src/qt/res/icons/HotShotCoin.icns
macx:TARGET = "HotShotCoin-Qt"
